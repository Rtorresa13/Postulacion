...
String cargoempleado =(String) session.getAttribute("cargo");
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
        ...
        <link href="css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
            ...
            <script>function actualizar(ruta){
 
    window.document.empleados.action=ruta;
    window.document.empleados.method="GET";
    window.document.empleados.op.value="6";
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <div class="dropdown-menu  "  aria-labelledby="navbarDropdown">
      ...
      <%if (cargoempleado.equals("Vendedor")){%>       
      <li class="nav-item">
    ...
    <form name="empleados" class="form-container col-md-6 ">
    ...
    <input type="text" value="<%=codigo%>" name="txtCodigo" readonly="readonly" class="form-control" >
  ...
  <div class="form-group">
    ...
    <input type="text" value="<%=direccion%>" name="txtDireccion" class="form-control"  >
  ...
  <p><%if (request.getAttribute("errorDireccion")!=null) { String errorDireccion =  (String)request.getAttribute("errorDireccion"); out.print(errorDireccion); } %>
    ...
    <input type="text" name="txtTel" value="<%=telefono%>" class="form-control" id="exampleInputEmail1">
  ...
  <option value="M" >M</option>
        ...
        <select name="cboCargo" class="custom-select custom-select-lg mb-3">
            ...
            <button  class=" btn btn-primary btn-block" onclick="actualizar('<%=request.getContextPath()%>/EmpleadoServlet')"> MODIFICAR</button><br>
        ...
        <ul class="list-unstyled">
          ...
          <li>
            ...
            <script src="js/empleado3.js" type="text/javascript"></script>
    </body>
</html>
