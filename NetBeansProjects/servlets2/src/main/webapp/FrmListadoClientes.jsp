...
<%! ClientesBean clientes = null;
    ArrayList<ClientesBean> lista =null; %> 

<%
lista=(ArrayList<ClientesBean>)request.getAttribute("lista");
...
<link href="css/default1.css" rel="stylesheet" type="text/css"/>
    ...
    window.document.ListadoClientes.op.value="6";
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <div class="dropdown-menu  "  aria-labelledby="navbarDropdown">
     ...
     <%}%>
      ...
      <form name="ListadoClientes" class="form-container col-md-7" >
   ...
   <option value="0" selected>Seleccione</option>
    ...
    <option value="2">Codigo</option>
      <option value="3">Nombre</option>
         ...
         <button class="btn btn-outline-success my-2 my-sl-0" onclick="Filtrar('<%=request.getContextPath()%>/ClienteServlet')" type="submit">Filtrar</button>
        </div>
       ...
       <table class="table tableContainer" style="border-color: black">
                  ...
                  <% for (ClientesBean obj: lista) { %>
                        ...
                        <td><button class="btn btn-outline-dark"onclick="Eliminar('<%=request.getContextPath()%>/ClienteServlet','<%=obj.getIdCliente()%>')">borrar</button> </td>
                        <td><button class="btn btn-outline-dark" OnClick= "modificar('<%=request.getContextPath()%>/ClienteServlet','<%=obj.getIdCliente()%>','<%=obj.getNombre()%>','<%=obj.getDni()%>','<%=obj.getSexo()%>')">Modificar</button></td>    
